...
### Revise step.funci and step.funcj to include trait or environmental variable with highest corrSum value, and repeat above procedure (i.e. TRAIT.3 or ENV.3). 
## Continue step selection until Pval <0.05 or corrSum <0.005 to optimize RLQ and find dominant trait-environment relationships.
